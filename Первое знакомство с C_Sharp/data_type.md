...
Вы можете познакомиться с полным списком встроенных типов данных в главе учебника по C# ["Встроенные типы данных"](http://msdn.microsoft.com/ru-ru/library/cs7y5x0x(v=vs.90).aspx).